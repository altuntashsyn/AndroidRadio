...
public class RadioAdapter extends ArrayAdapter<RadioDao> {
    ...
    public RadioAdapter(Context context, List<RadioDao> arrayList, List<RadioDao> notfiltered) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.text_radioName = (TextView) convertView.findViewById(R.id.text_radioName);
            holder.image_star = (ImageView) convertView.findViewById(R.id.image_star);
            holder.image_symbol = (ImageView) convertView.findViewById(R.id.image_symbol);
        ...
        holder.text_radioName.setTypeface(type);

        if (radioDao.getFavourite() == 1) {
            holder.image_star.setImageResource(R.drawable.bos_star);
        } else if (radioDao.getFavourite() == 2) {
            holder.image_star.setImageResource(R.drawable.starr);
        }
